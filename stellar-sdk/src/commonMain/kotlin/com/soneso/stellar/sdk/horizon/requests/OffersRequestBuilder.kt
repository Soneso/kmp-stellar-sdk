...
class OffersRequestBuilder(
    ...
    fun forBuyingAsset(asset: com.soneso.stellar.sdk.Asset): OffersRequestBuilder {
        return when (asset) {
            is com.soneso.stellar.sdk.AssetTypeNative -> forBuyingAsset("native")
            is com.soneso.stellar.sdk.AssetTypeCreditAlphaNum4 -> forBuyingAsset("credit_alphanum4", asset.code, asset.issuer)
            is com.soneso.stellar.sdk.AssetTypeCreditAlphaNum12 -> forBuyingAsset("credit_alphanum12", asset.code, asset.issuer)
        }
    }
