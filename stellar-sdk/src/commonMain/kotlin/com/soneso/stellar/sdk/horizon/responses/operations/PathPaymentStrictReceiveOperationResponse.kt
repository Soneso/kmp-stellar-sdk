 ...
 *
 * @see <a href="https://developers.stellar.org/docs/data/horizon/api-reference/resources/operations/object/path-payment-strict-receive">Operation documentation</a>
 */
@Serializable
@SerialName("path_payment_strict_receive")
data class PathPaymentStrictReceiveOperationResponse(
    @SerialName("id")
