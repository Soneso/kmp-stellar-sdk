 ...
 *
 * @see <a href="https://developers.stellar.org/docs/data/horizon/api-reference/resources/operations/object/clawback-claimable-balance">Operation documentation</a>
 */
@Serializable
@SerialName("clawback_claimable_balance")
data class ClawbackClaimableBalanceOperationResponse(
    @SerialName("id")
