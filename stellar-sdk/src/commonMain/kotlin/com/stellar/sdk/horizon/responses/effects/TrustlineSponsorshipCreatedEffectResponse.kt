 ...
 *
 * This effect occurs when sponsorship for a trustline is created.
 *
 * @see [Effect Documentation](https://developers.stellar.org/docs/data/horizon/api-reference/resources/effects)
 */
@Serializable
@SerialName("trustline_sponsorship_created")
data class TrustlineSponsorshipCreatedEffectResponse(
