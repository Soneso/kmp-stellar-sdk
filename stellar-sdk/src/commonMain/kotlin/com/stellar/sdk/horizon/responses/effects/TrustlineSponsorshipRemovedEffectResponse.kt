 ...
 *
 * This effect occurs when sponsorship for a trustline is removed.
 *
 * @see [Effect Documentation](https://developers.stellar.org/docs/data/horizon/api-reference/resources/effects)
 */
@Serializable
@SerialName("trustline_sponsorship_removed")
data class TrustlineSponsorshipRemovedEffectResponse(
