...
import com.stellar.sdk.horizon.responses.Price
import com.stellar.sdk.horizon.responses.TransactionResponse

/**
 * Represents ManageBuyOffer operation response.
 *
 * @see <a href="https://developers.stellar.org/docs/data/horizon/api-reference/resources/operations/object/buy-offer">Operation documentation</a>
 */
@Serializable
@SerialName("manage_buy_offer")
data class ManageBuyOfferOperationResponse(
    @SerialName("id")
