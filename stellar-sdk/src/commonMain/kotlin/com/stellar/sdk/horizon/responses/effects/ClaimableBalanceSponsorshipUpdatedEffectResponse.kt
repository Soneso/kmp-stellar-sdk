 ...
 *
 * This effect occurs when sponsorship for a claimable balance is updated.
 *
 * @see [Effect Documentation](https://developers.stellar.org/docs/data/horizon/api-reference/resources/effects)
 */
@Serializable
@SerialName("claimable_balance_sponsorship_updated")
data class ClaimableBalanceSponsorshipUpdatedEffectResponse(
