...
import com.stellar.sdk.StrKey
import com.stellar.sdk.Transaction
import com.stellar.sdk.TransactionBuilderAccount
import com.stellar.sdk.rpc.exception.AccountNotFoundException
 ...
 *
 * The typical flow is:
 * 1. Build transaction with [com.stellar.sdk.TransactionBuilder]
...
class SorobanServer(
     ...
     * [com.stellar.sdk.TransactionBuilder]. The account data is fetched from ledger entries.
     *
     * ## Example
     *
     * ```kotlin
