 ...
 *
 * @see <a href="https://developers.stellar.org/docs/data/horizon/api-reference/resources/operations/object/claim-claimable-balance">Operation documentation</a>
 */
@Serializable
...
data class ClaimClaimableBalanceOperationResponse(
    ...
    @SerialName("claimant_muxed")
    val claimantMuxed: String? = null,

    @SerialName("claimant_muxed_id")
    val claimantMuxedId: String? = null
) : OperationResponse()
