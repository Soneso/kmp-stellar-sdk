...
/**
 * Unit tests for [SmartAccountException.wrapError].
 *
...
class WrapErrorTest {
    ...
    fun testWrapError_smartAccountExceptionPassesThrough() {
        ...
        val result = SmartAccountException.wrapError(original)
    ...
    fun testWrapError_defaultCodeProducesValidationInvalidInput() {
        ...
        val result = SmartAccountException.wrapError(cause)
    ...
    fun testWrapError_invalidConfig() {
        val result = SmartAccountException.wrapError(RuntimeException("bad config"), SmartAccountErrorCode.INVALID_CONFIG)
    ...
    fun testWrapError_missingConfig() {
        val result = SmartAccountException.wrapError(RuntimeException("missing"), SmartAccountErrorCode.MISSING_CONFIG)
    ...
    fun testWrapError_walletNotConnected() {
        val result = SmartAccountException.wrapError(RuntimeException("not connected"), SmartAccountErrorCode.WALLET_NOT_CONNECTED)
    ...
    fun testWrapError_walletAlreadyExists() {
        val result = SmartAccountException.wrapError(RuntimeException("exists"), SmartAccountErrorCode.WALLET_ALREADY_EXISTS)
    ...
    fun testWrapError_walletNotFound() {
        val result = SmartAccountException.wrapError(RuntimeException("not found"), SmartAccountErrorCode.WALLET_NOT_FOUND)
    ...
    fun testWrapError_credentialNotFound() {
        val result = SmartAccountException.wrapError(RuntimeException("no cred"), SmartAccountErrorCode.CREDENTIAL_NOT_FOUND)
    ...
    fun testWrapError_credentialAlreadyExists() {
        val result = SmartAccountException.wrapError(RuntimeException("dup"), SmartAccountErrorCode.CREDENTIAL_ALREADY_EXISTS)
    ...
    fun testWrapError_credentialInvalid() {
        val result = SmartAccountException.wrapError(RuntimeException("invalid"), SmartAccountErrorCode.CREDENTIAL_INVALID)
    ...
    fun testWrapError_credentialDeploymentFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("deploy fail"), SmartAccountErrorCode.CREDENTIAL_DEPLOYMENT_FAILED)
    ...
    fun testWrapError_webAuthnRegistrationFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("reg failed"), SmartAccountErrorCode.WEBAUTHN_REGISTRATION_FAILED)
    ...
    fun testWrapError_webAuthnAuthenticationFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("auth failed"), SmartAccountErrorCode.WEBAUTHN_AUTHENTICATION_FAILED)
    ...
    fun testWrapError_webAuthnNotSupported() {
        val result = SmartAccountException.wrapError(RuntimeException("not supported"), SmartAccountErrorCode.WEBAUTHN_NOT_SUPPORTED)
    ...
    fun testWrapError_webAuthnCancelled() {
        val result = SmartAccountException.wrapError(RuntimeException("cancelled"), SmartAccountErrorCode.WEBAUTHN_CANCELLED)
    ...
    fun testWrapError_transactionSimulationFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("sim fail"), SmartAccountErrorCode.TRANSACTION_SIMULATION_FAILED)
    ...
    fun testWrapError_transactionSigningFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("sign fail"), SmartAccountErrorCode.TRANSACTION_SIGNING_FAILED)
    ...
    fun testWrapError_transactionSubmissionFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("submit fail"), SmartAccountErrorCode.TRANSACTION_SUBMISSION_FAILED)
    ...
    fun testWrapError_transactionTimeout() {
        val result = SmartAccountException.wrapError(RuntimeException("timeout"), SmartAccountErrorCode.TRANSACTION_TIMEOUT)
    ...
    fun testWrapError_signerNotFound() {
        val result = SmartAccountException.wrapError(RuntimeException("no signer"), SmartAccountErrorCode.SIGNER_NOT_FOUND)
    ...
    fun testWrapError_signerInvalid() {
        val result = SmartAccountException.wrapError(RuntimeException("bad signer"), SmartAccountErrorCode.SIGNER_INVALID)
    ...
    fun testWrapError_invalidAddress() {
        val result = SmartAccountException.wrapError(RuntimeException("bad addr"), SmartAccountErrorCode.INVALID_ADDRESS)
    ...
    fun testWrapError_invalidAmount() {
        val result = SmartAccountException.wrapError(RuntimeException("bad amount"), SmartAccountErrorCode.INVALID_AMOUNT)
    ...
    fun testWrapError_invalidInput() {
        val result = SmartAccountException.wrapError(RuntimeException("bad input"), SmartAccountErrorCode.INVALID_INPUT)
        assertIs<ValidationException.InvalidInput>(result)
        assertEquals(SmartAccountErrorCode.INVALID_INPUT, result.code)
    }
    ...
    fun testWrapError_storageReadFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("read fail"), SmartAccountErrorCode.STORAGE_READ_FAILED)
    ...
    fun testWrapError_storageWriteFailed() {
        val result = SmartAccountException.wrapError(RuntimeException("write fail"), SmartAccountErrorCode.STORAGE_WRITE_FAILED)
    ...
    fun testWrapError_sessionExpired() {
        val result = SmartAccountException.wrapError(RuntimeException("expired"), SmartAccountErrorCode.SESSION_EXPIRED)
    ...
    fun testWrapError_sessionInvalid() {
        val result = SmartAccountException.wrapError(RuntimeException("invalid session"), SmartAccountErrorCode.SESSION_INVALID)
    ...
    fun testAllErrorCodes_allCodesMapped() {
        ...
        for (code in SmartAccountErrorCode.entries) {
            ...
            val result = SmartAccountException.wrapError(cause, code)
