package com.soneso.stellar.sdk.unitTests.horizon.exceptions
...
class HorizonExceptionsTest {
    ...
    fun testAccountRequiresMemoExceptionToString() {
        ...
        assertEquals(
            "AccountRequiresMemoException(accountId='GTEST', operationIndex=2, message='Account requires memo')",
            exception.toString()
        )
    }
