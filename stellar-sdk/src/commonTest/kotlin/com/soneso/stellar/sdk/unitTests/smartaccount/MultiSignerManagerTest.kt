...
class MultiSignerManagerTest {
    ...
    @Test
    fun testMultiSignerTransfer_forceMethodNullDefault_signatureCompiles() = runTest {
        // Verify that the method accepts the default null forceMethod without compile errors.
        // The call will throw NotConnected (not SubmissionMethod-related), which confirms
        // the parameter is accepted with its default value of null.
        val kit = OZSmartAccountKit.create(buildConfig())
        val manager = kit.multiSignerManager
