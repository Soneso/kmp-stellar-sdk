...
class ClaimableBalancesRequestBuilderTest {
    ...
    fun testForAssetCredit() {
        ...
        // The issuer must survive: asserting only the code would pass with the issuer dropped
        assertEquals(
            "USD:GCDNJUBQSX7AJWLJACMJ7I4BC3Z47BQUTMHEICZLE6MU4KQBRYG5JY6B",
            url.parameters["asset"]
        )
        assertEquals("/claimable_balances", url.encodedPath)
        server.close()
    }
