...
class AccountsRequestBuilderTest {
    ...
    fun testForAsset() {
        ...
        val url = accountsBuilder.buildUrl()
        // The decoded value is the canonical CODE:ISSUER form Horizon expects
        assertEquals(
            "USD:GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN7",
            url.parameters["asset"]
        )
        // The wire form percent-encodes the separator
        assertEquals(
            "https://horizon-testnet.stellar.org/accounts" +
                "?asset=USD%3AGAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN7",
            url.toString()
        )
