...
/**
 * Round-trip tests for operation results across every result code.
 * Covers the Void/error variants of each operation plus success variants carrying payload data.
 */
class XdrOperationResultCodesTest {
