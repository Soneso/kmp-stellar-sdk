...
class OffersRequestBuilderTest {
    ...
    @Test
    fun testForBuyingAssetObjectNative() {
        val server = HorizonServer("https://horizon-testnet.stellar.org")
        val builder = server.offers()
            .forBuyingAsset(AssetTypeNative)
        val url = builder.buildUrl().toString()
        assertTrue(url.contains("buying=native"))
        server.close()
    }
    ...
    @Test
    fun testForBuyingAssetObjectCreditAlphaNum4() {
        val server = HorizonServer("https://horizon-testnet.stellar.org")
        val issuer = "GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN7"
        val builder = server.offers()
            .forBuyingAsset(AssetTypeCreditAlphaNum4("USD", issuer))
        val url = builder.buildUrl().toString()
        assertTrue(url.contains("buying=USD"))
        server.close()
    }
    ...
    @Test
    fun testForBuyingAssetObjectCreditAlphaNum12() {
        val server = HorizonServer("https://horizon-testnet.stellar.org")
        val issuer = "GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN7"
        val builder = server.offers()
            .forBuyingAsset(AssetTypeCreditAlphaNum12("LONGASSETCOD", issuer))
        val url = builder.buildUrl().toString()
    ...
    @Test
    fun testForSellingAssetObjectNative() {
        val server = HorizonServer("https://horizon-testnet.stellar.org")
        val builder = server.offers()
            .forSellingAsset(AssetTypeNative)
        val url = builder.buildUrl().toString()
        assertTrue(url.contains("selling=native"))
        server.close()
    }
    ...
    @Test
    fun testForSellingAssetObjectCreditAlphaNum4() {
        val server = HorizonServer("https://horizon-testnet.stellar.org")
        val issuer = "GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN7"
        val builder = server.offers()
            .forSellingAsset(AssetTypeCreditAlphaNum4("USD", issuer))
        val url = builder.buildUrl().toString()
    ...
    @Test
    fun testForSellingAssetObjectCreditAlphaNum12() {
        val server = HorizonServer("https://horizon-testnet.stellar.org")
        val issuer = "GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN7"
        val builder = server.offers()
            .forSellingAsset(AssetTypeCreditAlphaNum12("LONGASSETCOD", issuer))
        val url = builder.buildUrl().toString()
