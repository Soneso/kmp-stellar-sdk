...
class SorobanServerHeadersTest {
    ...
    fun testGetLedgerEntries_sendsClientHeaders() = runTest {
        ...
        val ledgerKey = com.stellar.sdk.xdr.LedgerKeyXdr.Account(
            com.stellar.sdk.xdr.LedgerKeyAccountXdr(
                accountId = com.stellar.sdk.xdr.AccountIDXdr(
                    com.stellar.sdk.xdr.PublicKeyXdr.Ed25519(
                        com.stellar.sdk.xdr.Uint256Xdr(ByteArray(32))
                    )
                )
            )
        )
    ...
    fun testGetEvents_sendsClientHeaders() = runTest {
        ...
        val filter = com.stellar.sdk.rpc.requests.GetEventsRequest.EventFilter(
            type = com.stellar.sdk.rpc.requests.GetEventsRequest.EventFilterType.CONTRACT,
            contractIds = null,
            topics = null
        )
        val request = com.stellar.sdk.rpc.requests.GetEventsRequest(
            startLedger = 1000,
    ...
    fun testSimulateTransaction_sendsClientHeaders() = runTest {
        ...
        val sourceKeypair = com.stellar.sdk.KeyPair.random()
        val sourceAccount = com.stellar.sdk.Account(sourceKeypair.getAccountId(), 1L)

        val contractHash = ByteArray(32)
        val contractId = com.stellar.sdk.xdr.ContractIDXdr(com.stellar.sdk.xdr.HashXdr(contractHash))

        val minimalSorobanData = com.stellar.sdk.xdr.SorobanTransactionDataXdr(
            ext = com.stellar.sdk.xdr.SorobanTransactionDataExtXdr.Void,
            resources = com.stellar.sdk.xdr.SorobanResourcesXdr(
                footprint = com.stellar.sdk.xdr.LedgerFootprintXdr(
                    readOnly = emptyList(),
                    readWrite = emptyList()
                ),
                instructions = com.stellar.sdk.xdr.Uint32Xdr(0u),
                diskReadBytes = com.stellar.sdk.xdr.Uint32Xdr(0u),
                writeBytes = com.stellar.sdk.xdr.Uint32Xdr(0u)
            ),
            resourceFee = com.stellar.sdk.xdr.Int64Xdr(0L)
        )

        val transaction = com.stellar.sdk.TransactionBuilder(sourceAccount, com.stellar.sdk.Network.TESTNET)
            .addOperation(
                com.stellar.sdk.InvokeHostFunctionOperation(
                    hostFunction = com.stellar.sdk.xdr.HostFunctionXdr.InvokeContract(
                        com.stellar.sdk.xdr.InvokeContractArgsXdr(
                            contractAddress = com.stellar.sdk.xdr.SCAddressXdr.ContractId(contractId),
                            functionName = com.stellar.sdk.xdr.SCSymbolXdr("test"),
                            args = emptyList()
                        )
                    ),
                    auth = emptyList()
