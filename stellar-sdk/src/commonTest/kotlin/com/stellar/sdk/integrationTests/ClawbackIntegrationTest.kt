...
import com.stellar.sdk.horizon.responses.effects.ClaimableBalanceClawedBackEffectResponse
import com.stellar.sdk.horizon.responses.effects.TrustlineFlagsUpdatedEffectResponse
import com.stellar.sdk.xdr.AccountFlagsXdr
...
class ClawbackIntegrationTest {
     ...
     */
    @Test
    fun testClawbackAndClaimableBalanceClawback() = runBlocking {
        withTimeout(240_000) { // 4 minute timeout for comprehensive test
