...
class AccountIntegrationTest {
     ...
     */
    @Test
    fun testStreamTransactionsForAccount() = runBlocking {
        // Create and fund account A
        val keyPairA = KeyPair.random()
        val accountAId = keyPairA.getAccountId()
        ...
        val stream = horizonServer.transactions()
            ...
            .cursor("now")
            .stream(
                serializer = com.stellar.sdk.horizon.responses.TransactionResponse.serializer(),
                listener = object : com.stellar.sdk.horizon.requests.EventListener<com.stellar.sdk.horizon.responses.TransactionResponse> {
                    override fun onEvent(event: com.stellar.sdk.horizon.responses.TransactionResponse) {
                        count++
