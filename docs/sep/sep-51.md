...
Reading a strkey applies the same rules the codec applies everywhere else;
[Addresses and StrKey](../addresses.md) states them. A strkey whose prefix does not
match the arm being read is rejected.
