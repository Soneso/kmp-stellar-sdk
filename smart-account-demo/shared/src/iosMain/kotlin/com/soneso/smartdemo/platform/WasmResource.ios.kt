 ...
 *
 * iOS bundles resources from commonMain/resources/wasm/ into the app's main bundle.
 ...
 * not actually suspend on iOS — it executes synchronously with zero overhead.
 */
    ...
    return try {
        ...
        val resourcePath = bundle.pathForResource("wasm/$resourceName", ofType = "wasm")
            ?: throw IllegalArgumentException(
                "WASM file not found in iOS app bundle: 'wasm/$wasmFilename'. " +
                "Ensure the file is present in commonMain/resources/wasm/ and is " +
                "included in the iOS app bundle resources."
            )
