 ...
 *   kotlin.jvm.JvmStatic
*/
- (NSString *)getCryptoLibraryName __attribute__((swift_name("getCryptoLibraryName()")));
...
@property (readonly) NSString *libraryName __attribute__((swift_name("libraryName")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Ed25519_cryptokitKt")))
@interface Stellar_sdkEd25519_cryptokitKt : Stellar_sdkBase
