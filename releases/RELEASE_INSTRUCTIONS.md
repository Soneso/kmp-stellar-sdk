...
The compatibility matrices are generated by Python scripts in `tools/sdk-analysis/`. They read the SDK version automatically from `gradle.properties`, so update the version there first, then regenerate.

Regenerate SEP matrices (only for SEPs that have data files in `tools/sdk-analysis/sep/data/`):
```bash
python3 tools/sdk-analysis/sep/generate_sep_matrix.py 0001
python3 tools/sdk-analysis/sep/generate_sep_matrix.py 0005
python3 tools/sdk-analysis/sep/generate_sep_matrix.py 0009
python3 tools/sdk-analysis/sep/generate_sep_matrix.py 0012
python3 tools/sdk-analysis/sep/generate_sep_matrix.py 0024
python3 tools/sdk-analysis/sep/generate_sep_matrix.py 0038
```

Regenerate Horizon and RPC matrices:
```bash
python3 tools/sdk-analysis/run_analysis.py
```

**Note**: SEP matrices without generator data files (e.g., SEP-6, SEP-8, SEP-10, SEP-45) must be updated manually. Check `tools/sdk-analysis/sep/data/` for available definitions.
