...
/**
 * Native (iOS/macOS) implementation for loading WASM resources.
 *
 * Uses Foundation Bundle APIs to read WASM files from the app bundle's resources.
 * This works for both iOS and macOS native applications.
 *
 * Note: This is marked as suspend for consistency with the JavaScript implementation,
 * but it doesn't actually suspend on Native (zero overhead).
 */
    ...
    return try {
        ...
        if (resourcePath == null) {
            throw IllegalArgumentException(
                ...
                "Ensure the file is included in the iOS/macOS app bundle resources under the wasm/ subdirectory."
            )
        }
